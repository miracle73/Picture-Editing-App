...
const SignupScreen = ({ navigation }) => {
    ...
    const onSubmit = async (data: ForgetPasswordInputs) => {
        setLoading(true)
        const res = await fetchData(`${PICSHUB_BACKEND_URL}/accounts/register`, {
    ...
    return (
        <View style={{ flex: 1, position: 'relative' }}>
            ...
            <LinearGradient
                ...
                locations={[0, 0.4, 0.6]}
                style={{ marginTop: 53, borderTopRightRadius: 33, borderTopLeftRadius: 33, position: 'relative', flex: 1 }}
            >
                <LinearGradient
                ...
                <BlurView intensity={20} style={{ overflow: 'hidden', flex: 1 }} >
                    <View style={{ paddingHorizontal: 16, paddingVertical: 18, borderTopRightRadius: 32, borderTopLeftRadius: 32 }}>
                        ...
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 12, marginBottom: 320 }}>
